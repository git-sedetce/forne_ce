...
router.post('/primeirologin', UserController.firstLogin)
router.get('/takeSexec', UserController.pegaSexec)
router.get('/takeProfiles', UserController.pegaProfiles)
...
router.get('/userbyid/:id', auth.authenticatedUser, checkRole.checkRole([1]), UserController.userId)
